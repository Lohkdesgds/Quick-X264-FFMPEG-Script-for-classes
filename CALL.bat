...
:: Drop a mp4 file into this to automatically convert a square video to 1600x1200 @ 100 kbps and 32 kbps mono audio for best ratio.
...
echo Automatic call: assuming square input, 1600x1200 output cropped @ 100 kbps video ^& 32 kbps audio mono
echo SOURCE: %IPATH%
echo OUTPUT: %OPATH%
...
set /p VIDBIT="Video bitrate (kbps, defaults 100): "
